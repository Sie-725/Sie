<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="住址" prop="home">
        <el-input
    ...
    <el-table v-loading="loading" :data="todoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="住址" align="center" prop="home" />
      <el-table-column label="更新时间" align="center" prop="updateDate" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['todo:todo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['todo:todo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="todoRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="住址" prop="home">
          <el-input v-model="form.home" placeholder="请输入住址" />
        </el-form-item>
        <el-form-item label="更新时间" prop="updateDate">
...
import { listTodo, getTodo, delTodo, addTodo, updateTodo } from "@/api/todo/todo";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除地址统计编号为"' + _ids + '"的数据项？').then(function() {
    return delTodo(_ids);
  }).then(() => {
    getList();
...
function handleExport() {
  proxy.download('todo/todo/export', {
    ...queryParams.value
